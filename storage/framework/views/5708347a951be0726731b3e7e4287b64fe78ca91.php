...
<div class="card card-purple collapsed-card">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-lg fa-fw fa-briefcase  mr-2"></i> Holidays
        </h3>
                ...
                <div class="row card-body">
                    <div class="col-12">
                        <div class="form-group ">
                            <label for="">Add Holiday(s)</label>
                            <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" id="" placeholder="Enter Holiday Name" required>
                        </div>
                        <div class="form-group">
...
<?php $component->withAttributes([]); ?>
        ...
        <tr>
            ...
            <td><?php echo e($h->start_date->format('F')); ?></td>
            <td><?php echo e($h->start_date->format('d')); ?></td>
            <?php if($h->end_date): ?>
            <td><?php echo e($h->end_date->format('d')); ?></td>
            <?php else: ?>
            <td>Single Day</td>
            <?php endif; ?>
            <td>
...
<?php $component->withAttributes([]); ?>
            <form action="<?php echo e(route('holidays.update', $h->id)); ?>" method="POST" id="<?php echo e('form-edit-'.$h->id); ?>">
                ...
                <div class="col-12">
                    ...
                    $config = ['format' => 'L'];
                    ?>
                    <div id="single-date<?php echo e($h->id); ?>" class="">
                         <?php if (isset($component)) { $__componentOriginalbfddb4fbd5cc3c689684d0828fb5b74a303abcc4 = $component; } ?>
...
<?php endif; ?> 
                    ...
                    <div id="multiple-date<?php echo e($h->id); ?>" class="d-none">
                         <?php if (isset($component)) { $__componentOriginal533dae895851e7fa774245f7511cc5528244f395 = $component; } ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jerald Lim\Desktop\Employee_mangement_system\resources\views/holiday/index.blade.php ENDPATH**/ ?>
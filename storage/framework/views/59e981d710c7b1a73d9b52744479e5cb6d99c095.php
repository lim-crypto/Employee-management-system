...
unset($__errorArgs, $__bag); ?>" name="firstName" value="<?php echo e(old('firstName')); ?>" id="" placeholder="Enter first name">
...
unset($__errorArgs, $__bag); ?>" name="lastName" value="<?php echo e(old('lastName')); ?>" id="" placeholder="Enter last name">
...
unset($__errorArgs, $__bag); ?>" name="dob" id="" value="<?php echo e(old('dob')); ?>" placeholder="Enter birth date" onfocus="(this.type='date')" onblur="(this.type='text')">
                                <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control <?php $__errorArgs = ['dateHired'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="dateHired" value="<?php echo e(old('dateHired')); ?>" id="" placeholder="Enter birth date" onfocus="(this.type='date')" onblur="(this.type='text')">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" id="" placeholder="Enter email">
...
unset($__errorArgs, $__bag); ?>" name="password" id="" placeholder="Enter Password">
...
unset($__errorArgs, $__bag); ?>" name="confirmPassword" id="" placeholder="Enter Password">

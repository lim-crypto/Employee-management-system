                            ...
                            <div class="row text-center">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo e(($attendance ? $attendance->registered>0 : $attendance ) ? $attendance->created_at->format('d-m-Y,  H:i:s')  : ''); ?>" class="form-control text-center" name="entry_time" id="entry_time" placeholder="--:--:--" disabled />
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row text-center" >
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-center" name="exit_time" id="exit_time" value="<?php echo e(($attendance ? $attendance->registered==2 : $attendance) ? $attendance->updated_at->format('d-m-Y,  H:i:s') : ''); ?>" placeholder="--:--:--" disabled />
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
...
<script>
    if ('<?php echo e(( $attendance ? $attendance->registered : $attendance)); ?>') {
            document.getElementById('entry_time').style = 'border:green 1px solid;';
            document.getElementById('entry_loc').style = 'border:green 1px solid;';


        } 
         if ('<?php echo e(( $attendance ? $attendance->registered==2 : $attendance)); ?>') {
            document.getElementById('exit_time').style = 'border:green 1px solid;';
            document.getElementById('exit_loc').style = 'border:green 1px solid;';
    ...
    function currentTime() {
        ...
        var dateNow = `${day}-${month}-${year}, ${hour}:${min}:${sec}`;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jerald Lim\Desktop\Employee_mangement_system\resources\views/attendance/create.blade.php ENDPATH**/ ?>
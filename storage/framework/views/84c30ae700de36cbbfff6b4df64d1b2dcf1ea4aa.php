...
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\Components\Form\DateRange::class, ['name' => 'date_range','config' => $config,'label' => 'Date Range']); ?>
...
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\Components\Widget\Card::class, ['title' => 'List of leave request','theme' => 'purple','icon' => 'fas fa-lg fa-fw fa-calendar-times']); ?>
...
<?php endif; ?> 
        ...
        <!-- edit-->
         <?php if (isset($component)) { $__componentOriginal3170ce38bba9a254ea7cdfc3b7aa9def8f17c1f0 = $component; } ?>
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\Components\Tool\Modal::class, ['id' => 'edit'.e($leave->id).'','title' => 'Edit Leave','theme' => 'purple','icon' => 'fas fa-edit','size' => 'md','vCentered' => true,'disableAnimations' => true]); ?>
<?php $component->withName('adminlte-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
            <form action="<?php echo e(route('leave.update', $leave->id)); ?>" method="POST" id="<?php echo e('form-edit-'.$leave->id); ?>">
                ...
                <div class="col-12">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="">Multiple Days</label>
                            <select name="multiple-days" class="form-control" onchange="document.getElementById('single-date<?php echo e($leave->id); ?>').classList.toggle('d-none');
                                        document.getElementById('multiple-date<?php echo e($leave->id); ?>').classList.toggle('d-none');
                                        document.getElementById('half-day<?php echo e($leave->id); ?>').classList.toggle('d-none');">
                                <option value="no" <?php echo e(!($leave->end_date) ? 'selected' : ''); ?>>No</option>
                                <option value="yes" <?php echo e(($leave->end_date) ? 'selected' : ''); ?>>Yes</option>
                            </select>
                        </div>
                        <div class="form-group hide-input <?php echo e(($leave->end_date) ? 'd-none' : ''); ?>" id="half-day<?php echo e($leave->id); ?>">
                            <label>Half Day</label>
                            <select class="form-control" name="half-day">
                                <option value="no" <?php echo e($leave->half_day=='no' ? 'selected' : ''); ?>>No</option>
                                <option value="yes" <?php echo e($leave->half_day=='yes' ? 'selected' : ''); ?>>Yes</option>
                            </select>
                        </div>
                        <?php
                        $config = ['format' => 'L'];
                        ?>
                        <div id="single-date<?php echo e($leave->id); ?>" class="<?php echo e(($leave->end_date) ? 'd-none' : ''); ?>">
                             <?php if (isset($component)) { $__componentOriginalbfddb4fbd5cc3c689684d0828fb5b74a303abcc4 = $component; } ?>
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\Components\Form\InputDate::class, ['name' => 'date','id' => ''.e($leave->id).'','config' => $config,'label' => 'Date']); ?>
<?php $component->withName('adminlte-input-date'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($leave->start_date->format('m/d/Y')).'','placeholder' => 'Choose a date...']); ?>
                                 <?php $__env->slot('prependSlot'); ?> 
                                    <div class="input-group-text bg-white">
                                        <i class="far fa-lg fa-calendar-alt text-purple"></i>
                                    </div>
...
<?php endif; ?> 
                        ...
                        <div id="multiple-date<?php echo e($leave->id); ?>" class=" <?php echo e(!($leave->end_date) ? 'd-none' : ''); ?>">
                             <?php if (isset($component)) { $__componentOriginal533dae895851e7fa774245f7511cc5528244f395 = $component; } ?>
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\Components\Form\DateRange::class, ['name' => 'date_range','id' => 'date_range'.e($leave->id).'','config' => $config,'label' => 'Date Range']); ?>
<?php $component->withName('adminlte-date-range'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($leave->start_date->format('m/d/Y')).'\' - \''.e(( $leave->end_date) ?  $leave->end_date->format('m/d/Y') : $leave->start_date->format('m/d/Y')).'','placeholder' => 'Select a date range...']); ?>
                                 <?php $__env->slot('prependSlot'); ?> 
                                    <div class="input-group-text bg-gradient-purple">
                                        <i class="far fa-lg fa-calendar-alt"></i>
                                    </div>
...
<?php endif; ?> 
                        ...
                        <div class="form-group">
                            <label for="">Reason</label>
                            <input type="text" name="reason" value="<?php echo e(old('reason')  ?   old('reason')  : $leave->reason); ?>" class="form-control">
                            <?php $__errorArgs = ['reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label for="">Description</label>
                            <textarea name="description" class="form-control"><?php echo e(old('description') ? old('description') : $leave->description); ?></textarea>
                            <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php endif; ?> 
        ...
        <!-- delete-->
         <?php if (isset($component)) { $__componentOriginal3170ce38bba9a254ea7cdfc3b7aa9def8f17c1f0 = $component; } ?>
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\Components\Tool\Modal::class, ['id' => 'delete'.e($leave->id).'','title' => 'Delete leave?','size' => 'sm','theme' => 'danger','icon' => 'fas fa-calendar-times','vCentered' => true,'scrollable' => true]); ?>
<?php $component->withName('adminlte-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jerald Lim\Desktop\Employee_management_system\resources\views/leave/create.blade.php ENDPATH**/ ?>
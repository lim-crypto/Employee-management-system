                         ...
                         <div class="col-md-6">
                             ...
                             <div class="form-group">
                                 ...
                                 <select class="form-control" name="department_id">
                                     ...
                                     <option value="<?php echo e($dd=$d->id); ?>" id="<?php echo e($ud=$user->department_id); ?>" <?php echo e(old('department_id')==$dd ? 'selected' : ( ($ud==$pp) ? 'selected': ''  )); ?>><?php echo e($d->name); ?></option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                             </div>
                             <div class="form-group">
                                 ...
                                 <select class="form-control" name="role_id">
                                     ...
                                     <option value="<?php echo e($rr=$r->id); ?>" id="<?php echo e($ur=$user->department_id); ?>" <?php echo e(old('role_id')==$rr ? 'selected' : ( ($ur==$pp) ? 'selected': ''  )); ?>><?php echo e($r->name); ?></option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                             </div>
                         </div>
                         ...
                         <div class="col-md-6">
                             ...
                             <div class="form-group ">
                                 ...
                                 <select class="form-control" name="civilStatus" id="gender">
                                     ...
                                     <option <?php echo e((old('civilStatus')=='Married' ) ? 'selected' : ( ( ($g) =='Married' ) ? 'selected' : '')); ?>>Married</option>
                                     <option <?php echo e((old('civilStatus')=='Widowed' ) ? 'selected' : ( ( ($g) =='Widowed' ) ? 'selected' : '')); ?>>Widowed</option>
                                     <option <?php echo e((old('civilStatus')=='Divorced' ) ? 'selected' : ( ( ($g) =='Divorced' ) ? 'selected' : '')); ?>>Divorced</option>
                                 </select>
                             </div>
                         </div>
                         <!-- /.card-body -->
...
<?php endif; ?> 
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jerald Lim\Desktop\Employee_mangement_system\resources\views/users/index.blade.php ENDPATH**/ ?>
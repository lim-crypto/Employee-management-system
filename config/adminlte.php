...
return [
    ...
    */
    ...
    'logo' => '<b>Axis</b>',
    'logo_img' => 'vendor/adminlte/dist/img/axis.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active' => ['regex:@^users/[0-9]+$@']
        ],
        [
            'text' => 'Edit Profile',
            'route' => ['users.edit', ['user' => 1]], // this is not the real user
            'icon' => 'fas fa-fw fa-user-edit',
            'active' => []
        ],
        [
            'text' => 'change_password',
            'route' => ['users.changePassword', ['user' => 1]], // this is not the real user
